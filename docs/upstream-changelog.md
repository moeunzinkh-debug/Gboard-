# Upstream changelog (inherited history)

Kept for reference. These entries belong to the 3.x line of [jasonwu1994/Gboard-patches](https://github.com/jasonwu1994/Gboard-patches) which this repository was derived from. They are listed here on purpose so that this source can keep its own version line starting at 1.0.0 (Morphe Manager compares the numbers in `CHANGELOG.md` to decide which entries count as "new since your version").
